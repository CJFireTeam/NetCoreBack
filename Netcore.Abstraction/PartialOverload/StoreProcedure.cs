...
namespace Netcore.Abstraction.PartialOverload
{
    public static class StoreProcedure
    {
        ...
        public static List<T> ExecuteStoredProc<T>(this DbCommand command, string connectionString)
        {
            using (command)
            {
        ...
        public static async Task<List<T>> ExecuteStoredProcAsync<T>(this DbCommand command, string connectionString)
        {
            using (command)
            {
                if (command.Connection.State == System.Data.ConnectionState.Closed)
